...
export default function App() {
  ...
  const [currentEmotion, setCurrentEmotion] = useState("Mutlu");
    ...
    try {
      ...
      mediaRecorder.onstop = async () => {
        ...
        try {
          ...
          const predTr = api.prediction_tr || null;
    ...
    <div className="container">
      ...
      <div className="hero">
        ...
        <div className="emojis">
          {emojis.map((e) => (
            <div
              ...
              title={e.label}
              style={{
                border: e.label === currentEmotion ? "2px solid #007bff" : "none",
                borderRadius: "8px",
                padding: "6px 8px",
        ...
        {currentEmotion && (
          ...
          >
            <div className="emotion-icon">{getEmotionIcon(currentEmotion)}</div>
            <div className="emotion-text">{currentEmotion}</div>
          </div>
        )}
